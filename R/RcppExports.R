...
StopServer <- function() {
    invisible(.Call('rcppMagmaSYEVD_StopServer', PACKAGE = 'rcppMagmaSYEVD'))
}
...
.CleanupSharedMemory <- function() {
    .Call('rcppMagmaSYEVD_CleanupSharedMemory', PACKAGE = 'rcppMagmaSYEVD')
}
...
GetServerArgs <- function(matrixDimension, withVectors, numGPUsWanted, memName, semName, printDetails) {
    .Call('rcppMagmaSYEVD_GetServerArgs', PACKAGE = 'rcppMagmaSYEVD', matrixDimension, withVectors, numGPUsWanted, memName, semName, printDetails)
}
...
eigen_mgpu <- function(matrix, symmetric = TRUE, only_values = FALSE, overwrite = FALSE, printInfo = FALSE) {
    .Call('rcppMagmaSYEVD_eigen_mgpu', PACKAGE = 'rcppMagmaSYEVD', matrix, symmetric, only_values, overwrite, printInfo)
}
...
sqrt_invsqrt <- function(matrix, symmetric, printInfo = FALSE) {
    .Call('rcppMagmaSYEVD_sqrt_invsqrt', PACKAGE = 'rcppMagmaSYEVD', matrix, symmetric, printInfo)
}
